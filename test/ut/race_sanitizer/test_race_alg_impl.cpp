...
TEST(RaceAlgImpl, dynamic_gm_write_event_with_mem_event_expect_race_error)
{
...
TEST(RaceAlgImpl, dynamic_gm_write_event_with_mem_event_expect_normal)
{
    RaceAlgImpl alg(KernelType::AIVEC, DeviceType::ASCEND_950DT_950x, 3);
    SanEvent event;
    event.loc.coreId = 0;
...
TEST(RaceAlgImpl, dynamic_ub_write_event_with_mem_event_expect_normal)
{
    RaceAlgImpl alg(KernelType::AIVEC, DeviceType::ASCEND_950DT_950x, 3);
    SanEvent event;
    event.loc.coreId = 0;
    ...
    event.loc.blockType = BlockType::AIVEC;
    auto &dynamicOpInfo = event.eventInfo.dynamicOpInfo;
    dynamicOpInfo.memType = MemType::UB;
    dynamicOpInfo.count = 2;
    dynamicOpInfo.minAddr = 0X100;
    dynamicOpInfo.maxAddr = 0x500;
    dynamicOpInfo.dynamicType = RecordType::SIMT_ENTRY;
...
TEST(RaceAlgImpl, dynamic_ub_write_event_with_mem_event_expect_race_error)
{
    RaceAlgImpl alg(KernelType::AIVEC, DeviceType::ASCEND_950DT_950x, 3);
    SanEvent event;
    event.loc.coreId = 0;
