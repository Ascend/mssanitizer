...
请严格按照《[昇腾 AI 算子开发工具链学习环境安装指南](https://gitcode.com/Ascend/msot/blob/26.0.0/docs/zh/quick_start/installation_guide.md)》完成环境安装与工作区配置。即使您已具备类似环境，也需按该指南重新执行一遍，以确保所有依赖组件、环境变量等完整一致。
...
按照《[昇腾算子开发工具链快速入门](https://gitcode.com/Ascend/msot/blob/26.0.0/docs/zh/quick_start/op_tool_quick_start.md)》中的指导，完成 2.1 节和 2.3 节。
