...
std::ostream &operator<<(std::ostream &os, DsbRecord const &record) {
    return os << record.location << ", " << "pipe:" << record.pipe << ", "
              << "memDomain:" << static_cast<uint32_t>(record.memDomain);
}
...
static const std::map<RecordType, KernelRecordStreamFunc> KERNEL_RECORD_FORMAT_MAP = {
    ...
    {RecordType::LOAD_2D_SPARSE, [](std::ostream &os, KernelRecord const &r) { os << r.payload.load2DSparseRecord; }},
    ...
    {RecordType::LOAD_A_WINOGRAD, [](std::ostream &os, KernelRecord const &r) { os << r.payload.loadAWinogradRecord; }},
    {RecordType::LOAD_B_WINOGRAD, [](std::ostream &os, KernelRecord const &r) { os << r.payload.loadBWinogradRecord; }},
    ...
    {RecordType::DSB, [](std::ostream &os, KernelRecord const &r) { os << r.payload.dsbRecord; }},
    ...
    {RecordType::WAIT_FLAG_DEV_PIPE,
        [](std::ostream &os, KernelRecord const &r) { os << r.payload.waitFlagDevPipeRecord; }},
    {RecordType::WAIT_FLAG_DEVI_PIPE,
        [](std::ostream &os, KernelRecord const &r) { os << r.payload.waitFlagDevPipeRecord; }},
    {RecordType::SET_INTRA_BLOCK,
        [](std::ostream &os, KernelRecord const &r) { os << r.payload.intraBlockSyncRecord; }},
    ...
    {RecordType::SET_FFTS_BASE_ADDR,
        [](std::ostream &os, KernelRecord const &r) { os << r.payload.registerSetRecord; }},
    ...
    {RecordType::THREAD_BLOCK_BARRIER,
        [](std::ostream &os, KernelRecord const &r) { os << r.payload.simtEmptyRecord; }},
